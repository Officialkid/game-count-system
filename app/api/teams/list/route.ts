...
import { listTeamsSchema } from '@/lib/validations';
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Validate input
    const validation = listTeamsSchema.safeParse({ event_id });
    ...
    const teams = await db.listTeamsByEvent(validation.data.event_id);
